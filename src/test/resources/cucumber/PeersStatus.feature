Feature: start/stop downloading/uploading
  ...
  Scenario Outline: (3) start listen
    Given initial torrent-status for torrent: "<torrent>" in "<downloadLocation>" is:
      | PAUSE_DOWNLOAD_WIND_UP                    |
      | PAUSE_UPLOAD_WIND_UP                      |
      | PAUSE_LISTENING_TO_INCOMING_PEERS_WIND_UP |
  ...
  Scenario Outline: (4) pause listen when we already in pause listen state
    Given initial torrent-status for torrent: "<torrent>" in "<downloadLocation>" is:
      | PAUSE_DOWNLOAD_WIND_UP                    |
      | PAUSE_UPLOAD_WIND_UP                      |
      | PAUSE_LISTENING_TO_INCOMING_PEERS_WIND_UP |
  ...
  Scenario Outline: (6) fail to start resume listen when we don't actually listen
    Given initial torrent-status for torrent: "<torrent>" in "<downloadLocation>" is:
      | PAUSE_DOWNLOAD_WIND_UP                    |
      | PAUSE_UPLOAD_WIND_UP                      |
      | PAUSE_LISTENING_TO_INCOMING_PEERS_WIND_UP |
  ...
  Scenario Outline: (10) start listen -> resume listen (with pauses)
    Given initial torrent-status for torrent: "<torrent>" in "<downloadLocation>" is:
      | PAUSE_DOWNLOAD_WIND_UP                    |
      | PAUSE_UPLOAD_WIND_UP                      |
      | PAUSE_LISTENING_TO_INCOMING_PEERS_WIND_UP |
    ...
    Then torrent-status for torrent "<torrent>" will be with action: "RESUME_LISTENING_TO_INCOMING_PEERS_WIND_UP":
      | PAUSE_DOWNLOAD_WIND_UP                     |
      | PAUSE_UPLOAD_WIND_UP                       |
      | PAUSE_SEARCHING_PEERS_WIND_UP              |
      | START_LISTENING_TO_INCOMING_PEERS_WIND_UP  |
