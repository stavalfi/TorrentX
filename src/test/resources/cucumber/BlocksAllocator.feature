...
#
#  Scenario: we allocate too much blocks from single thread
#    Given allocator for "1" blocks with "17_000" bytes each
#    When the application allocate "2" blocks from "3" threads:
#    Then the allocator have the following free blocks - none
#    Then the allocator have the following used blocks:
#      | 0 |
#    When the application free the following blocks:
